...
// Použijeme typ přímo z Prisma, abychom měli jistotu
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden hover:shadow-lg transition-all duration-300 group">
        ...
        <CardHeader className="p-4 pb-2">
            <CardTitle className="text-lg font-serif tracking-wide">{product.name}</CardTitle>
        </CardHeader>
